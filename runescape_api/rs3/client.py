...
class RS3Client:
    def __init__(self, timeout: int = 30, _http_adapter: Optional[BaseHttpAdapter] = None):
        """
        Entry point for the RuneScape 3 API client.

        The HTTP adapter is considered an internal dependency.
        It may be overridden for testing purposes.
        """
        self.http_adapter = _http_adapter or RestAdapter(timeout=timeout)
